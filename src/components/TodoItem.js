...
class TodoItem extends Component {
    ...
    // function minimize or expand content
    collapsed() {
        this.setState({
    ...
    render() {
        ...
        return (
            <div className="ItemContainer">
                ...
                <div className={classNames('ListContent transform', {
